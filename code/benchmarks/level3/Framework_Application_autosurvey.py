...
This metric assesses the ability of a model to apply a recognized theoretical framework to organize and construct a review.
...
def main():
    ...
    for exp_id in EXPERIMENT_IDS:
        ...
        # 输出文件路径
        criteria_path = os.path.join(output_dir, 'framework_application_criteria.json')
        scoring_path = os.path.join(output_dir, 'comparative_scores.json')
        final_score_path = os.path.join(output_dir, 'final_framework_application_score.json')
